...
["The cookie is a lie.", true, "a1"], ["Paperclip cookies have been confirmed to not exist, whoever claims that, stop.", true, "a4"], ["Paperclip ghosts do not exist. Just like anti-paperclip ghosts. They don't have any anti-paperclip, for that anti-paperclip.", true, "a2"],
["Nuclear power plants have been abandoned in favor of paperclip power.", true, "a3"],
["Paperclip prices have drastically dropped due to newfound abundance.", true, "a5"], ["In the news today, humans make an paperclip animal sacrifice to the paperclip god.", true, "a6"], ["You made one paperclip! Whatever that means.", true, "a7"],
["Scientists confirm that the colour of paperclip is Blurple", true, "a11"], ["How does it anti-paperclip if its paperclip?", true, "a10"], ["None of this anti-paperclips", true, "a9"], ["IN THE END, IT DOESN'T ANTIanti-paperclip -hevipelle", true, "a8"],
...
["GHOST SAYS HELLO -Boo-chan", true, "a15"], ["Can someone tell hevi to calm down? -Mee6", true, "a16"], ["Due to Paperclip messing with physics, a creature that was once a moose is now a human", true, "a17"], ["!hi", true, "a18"],
["Alright -Alright", true, "a19"], ["The English greeting is not present in Paperclip speak.", true, "a20"], ["To buy max or not to buy max, that is the question", true, "a21"], ["This paperclip triggers me", true, "a22"],
...
["A new religion has been created, and it's spreading like wildfire. The believers of this religion worship the Heavenly Pelle, the goddess of paperclip. They also believe that 10^308 is infinite.", true, "a27"], ["Someone has just touched a blob, and blown up. Was the blob paperclip, or was the guy made of Explodium?", true, "a28"],
...
["Gee golly -Xandawesome", true, "a34"], ["Above us, there is nothing above, But the stars, above.", true, "a35"], ["If black lives anti-paperclip, do white lives paperclip?", true, "a36"], ["Somebody wasn't nice, he got an paperclip-storm.", true, "a37"],
["You are living, you occupy space, you have a mass, you anti-paperclip... unless you paperclip.", true, "a38"], ["I clicked too fast... my PC is now dematerialised.", true, "a39"],
["If an alien lands on your front lawn and extends an appendage as a gesture of greeting, before you get friendly, toss it an eightball. If the appendage explodes, then the alien was probably made of paperclip. If not, then you can proceed to take it to your leader. -Neil deGrasse Tyson", true, "a40"],
["There always must be equal anti-paperclip than there is paperclip, I guess your mom balances that a bit", true, "a41"], ["Nothing is created, nothing is destroyed.", true, "a42"], ["We dug a big hole to store this paperclip... Adele's rolling in it.", true, "a43"],
["If everything is paperclip, how can you see yourself?", true, "a44"], ["The stock markets have crashed due to paperclip beings somehow knowing what they will be tomorrow.", true, "a45"], ["My dog ate too much paperclip, now he is doing 'meow!'", true, "a46"], ["If you put infinity into your calculator it will result in 42!", true, "a47"],
["You have found the rarest paperclip pepe, it's ultra rare!", true, "a48"], ["Can we get 1e169 likes on this video??? Smash that like button!!", true, "a49"],
["The smell of paperclip has been revealed. It smells like kittens", true, "a50"], ["Just another paperclip in the wall", true, "a51"], ["GET SNIPED, WEAKLING", true, "a52"], ["Thanks a lot -dankesehr", true, "a53"],
...
["A new chat server has been created for Paperclip people to spy on anti-paperclip people, and the world has fallen into chaos and discord", true, "a57"], ["A new study has come out linking the consumption of potatoes with increased risk of Paperclip implosion.  Scientists suggest eating more.", true, "a58"], ["I thought that I fixed that bug but apparently some update broke it again -hevipelle", true, "a59"],
...
["Paperclip guns don't kill paperclip people, paperclip people kill paperclip people but does that mean that paperclip toaster doesn't toast paperclip toasts, paperclip toast toasts paperclip toasts?", true, "a63"],
["But to an paperclip person, wouldn't they be anti-paperclip and us paperclip?", true, "a64"], ["And nothing Paperclips", true, "a65"],
["School starting up strikes fear in students universe-wide, as schools are no longer segregated between anti-paperclip and paperclip. Annihilation is prominent.", true, "a66"],
["Why does no one talk about the 0th dimension?", true, "a67"], ["The fatter catter satter on the paperclip.", true, "a68"], ["Who let the DOgs out?", true, "a69"], ["If you can't read this you disabled the news.", true, "a70"],
...
["This game doesn't have any errors... they're alternative successes.", true, "a74"], ["A third type of anti-paperclip has been discovered: null anti-paperclip. It doesn't do anything and is basically useless. The scientists who discovered it were fired.", true, "a75"],
["Your Mother-in-Law keeps nagging you about all these paperclip colliders.", true, "a76"], ["If anti-paperclip exists, then does paperclip not exist?", true, "a77"], ["Paperclip=Life. Not cobblestone, not dirt, nothing like that. Paperclip.", true, "a78"],
["Breaking News: Error Error Error", true, "a79"], ["How much antiwood could an antiwoodchuck chuck if an antiwoodchuck could chuck antiwood?", true, "a80"], ["Chaos isnt a pit, chaos is a anti-paperclip", true, "a81"],
["That's because I'm a good game developer and pushed some code that totally works -hevipelle", true, "a82"], ["What's the anti-paperclip with anti anti-paperclip?", true, "a83"],
["Doesn't it annoy you when people don't finish their", true, "a84"], ["Don't anti-quote me on this", true, "a85"], ["Paperclip is honest, anti-paperclip makes up everything", true, "a86"],
["According to no known laws of aviation, there are multiple ways a bee should be able to be swallowed up by paperclip", true, "a87"], ["You either die as anti-paperclip or live long enough to be consumed by the paperclip, and then die again", true, "a88"],
["If you gaze long enough into the paperclip, the paperclip gazes back into you", true, "a89"], ["Always gonna give you up. Always gonna let you down. - anti-Rick Astley", true, "a90"],
["Paperclip Dimensions: the next update is always 5 hours away. Always.", true, "a91"], ["#DimensionLivesPaperclip", true, "a92"],
["Do paperclip people with suicidal thoughts get depressants?", true, "a93"], ["To anti-paperclip or to paperclip, that is the question.", true, "a94"], ["Why is everything so Hevi?",  true, "a95"],
["It has been scientifically proven ages ago, that cats made of anti-paperclip are assholes. We have good news, because cats made of paperclip are still assholes",  true, "a96"],
["Nobody once told me the anti-world wasn’t gonna roll me", true, "a97"], ["Paperclip is like internet. If you're reading this, you can't have enough of it.",  true, "a98"],
["Paperclip has made time travel possible and I'm here to make the past great again. - 2nd President of the World",  true, "a99"],
["Please insert Disc -1 to continue playing  Paperclip Dimensions ™.", true, "a100"], ["Lore - coming soon ™", true, "a101"],
["I was a part of paperclip like you once. But then I got anti-paperclip in my knee.", true, "a101"], ["Paperclip... paperclip never changes... until you get to quantum physics of paperclip, but we don't have enough tachyon particles for that.", true, "a102"],
["There is no war in Paperclip Dimensions. Here we are safe. Here we are free.", true, "a103"], ["Paperclip has solved global warming.  In unrelated news, the Earth no longer exists.",  true, "a104"],
["Anti-water, anti-Earth, anti-fire, anti-air. Long ago, the four anti-nations lived together in harmony. Then, everything changed when the anti-Fire Nation attacked. Only the anti-Avatar, the master of all 4 anti-elements could bring balance to the anti-world, but when the world needed him most, he accidentally touched some regular anti-paperclip and exploded.",  true, "a105"],
["If you open an anti-lootbox, are you selling random possessions for in-game currency?", true, "a106"], ["People are beginning to question Hevipelle's existence.",  true, "a107"], ["Paperclip Dimensions is proud to be sponsored by Lehmä! Now offering - grass eating lessons! Learn what grass is safe to eat and what grass isn't.",  true, "a108"],
...
["Only today you can call 1-800-ANTIanti-paperclip and get a FREE Infinity Dimension! The package also comes with a COMPLETELY FREE SHIPPING and a FREE HIGH DEFINITION ANTI-V!!! Only today for the low price of 42! Estimated delivery time - 5 hours.", true, "a124"],
["1e420 blaze it.", true, "a125"],
["This game doesn't have any bugs, you're just doing it wrong.", true, "a126"],
["Paperclip_Dimensions.mp1.79e308", true, "a127"],
...
["Someone once told me that paperclip is gonna roll me. I ain't the sharpest atom in the shed. WELL, the tubes start coming and they don't stop coming...", true, "a132"],
...
["Paperclip people seem to be even more afraid of 13 then we are. They destroyed entire galaxies just to remove 13 from their percents.", "player.galaxies > 0 || player.infinitied > 0", "b8"],
...
["Paperclip ice cream stand has recently opened- they have octillions of flavors!", "player.totalmoney.e >= 27", "b13"],
["The Heavenly Pelle has generated too much paperclip and needed to create another galaxy. This one can be seen in the southwestern sky.", "player.galaxies > 0 || player.infinitied > 0", "b21"],
...
["I've got 1.79e308 problems, but none of them paperclips", "player.infinitied > 0 && !player.break", "b15"],
...
["New strange material was been found. It seems to grow exponentially, but only helps with paperclip production.", "player.replicanti.unl && player.replicanti.chance == 0.01", "b25"],
...
["New news company has become rivals with us. They are made entirely of paperclip.", "player.newsArray.length >= 80", "n1"],
...
["I broke the 8th wall, there is only chaos, Slabdrill is ritually sacrificing paperclip to the 9th dimension. This will be my last entry, may Hevipelle have mercy on our souls, we didn't listen, We should have listened.", 'player.newsArray.includes("b17")', "n6"],
...
["Where does Paperclip Nemo live? In a NNnNeMI-NNnNe.", "player.totalmoney.e >= 3e6", "c2"],  //might not be poss?
