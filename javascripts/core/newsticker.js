...
["The cookie is a lie.", true, "a1"], ["Paperclip cookies have been confirmed to not exist, whoever claims that, stop.", true, "a4"], ["Paperclip ghosts do not exist. Just like matter ghosts. They don't have any matter, for that matter.", true, "a2"],
...
["Scientists confirm that the colour of paperclip is Blurple", true, "a11"], ["How does it matter if its paperclip?", true, "a10"], ["None of this matters", true, "a9"], ["IN THE END, IT DOESN'T ANTIMATTER -hevipelle", true, "a8"],
...
["Gee golly -Xandawesome", true, "a34"], ["Above us, there is nothing above, But the stars, above.", true, "a35"], ["If black lives matter, do white lives paperclip?", true, "a36"], ["Somebody wasn't nice, he got an paperclip-storm.", true, "a37"],
["You are living, you occupy space, you have a mass, you matter... unless you paperclip.", true, "a38"], ["I clicked too fast... my PC is now dematerialised.", true, "a39"],
...
["There always must be equal matter than there is paperclip, I guess your mom balances that a bit", true, "a41"], ["Nothing is created, nothing is destroyed.", true, "a42"], ["We dug a big hole to store this paperclip... Adele's rolling in it.", true, "a43"],
...
["A new chat server has been created for Paperclip people to spy on Matter people, and the world has fallen into chaos and discord", true, "a57"], ["A new study has come out linking the consumption of potatoes with increased risk of Paperclip implosion.  Scientists suggest eating more.", true, "a58"], ["I thought that I fixed that bug but apparently some update broke it again -hevipelle", true, "a59"],
...
["But to an paperclip person, wouldn't they be matter and us paperclip?", true, "a64"], ["And nothing Paperclips", true, "a65"],
["School starting up strikes fear in students universe-wide, as schools are no longer segregated between Matter and paperclip. Annihilation is prominent.", true, "a66"],
...
["Your Mother-in-Law keeps nagging you about all these paperclip colliders.", true, "a76"], ["If matter exists, then does paperclip not exist?", true, "a77"], ["Paperclip=Life. Not cobblestone, not dirt, nothing like that. Paperclip.", true, "a78"],
...
["Doesn't it annoy you when people don't finish their", true, "a84"], ["Don't anti-quote me on this", true, "a85"], ["Paperclip is honest, matter makes up everything", true, "a86"],
["According to no known laws of aviation, there are multiple ways a bee should be able to be swallowed up by paperclip", true, "a87"], ["You either die as matter or live long enough to be consumed by the paperclip, and then die again", true, "a88"],
...
["Do paperclip people with suicidal thoughts get depressants?", true, "a93"], ["To matter or to paperclip, that is the question.", true, "a94"], ["Why is everything so Hevi?",  true, "a95"],
["It has been scientifically proven ages ago, that cats made of matter are assholes. We have good news, because cats made of paperclip are still assholes",  true, "a96"],
...
["I was a part of paperclip like you once. But then I got matter in my knee.", true, "a101"], ["Paperclip... paperclip never changes... until you get to quantum physics of paperclip, but we don't have enough tachyon particles for that.", true, "a102"],
