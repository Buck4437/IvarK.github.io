...
var normalDimChart = new Chart(ctx2, {
    ...
    data: {
        labels: [],
        datasets: [{
            label: ['Exponents of Paperclip per second'],
            data: [],
            backgroundColor: [
                'rgba(0,0,0,1)'
            ],
...
function addData(chart, label, data) {
    ...
    if (document.getElementById("Paperclipdimensions").style.display == "block" && document.getElementById("production").style.display == "block") chart.update(100);
    else chart.update(0);
}
